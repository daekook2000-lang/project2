  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
      ...
      <div className="flex items-center justify-center min-h-screen pt-20 pb-32">
        <div className="w-full max-w-7xl mx-auto px-12 text-center">
          <h1 className="text-7xl sm:text-8xl lg:text-9xl font-black text-white mb-16 leading-tight">
            사진 한 장으로
            <br />
          ...
          <p className="text-3xl text-gray-300 leading-relaxed max-w-4xl mx-auto">
      ...
      <div className="flex items-center justify-center min-h-screen pb-32">
        <div className="w-full max-w-7xl mx-auto px-12 text-center">
          <button className="group relative bg-gradient-to-r from-purple-600 to-pink-600 text-white px-24 py-10 rounded-3xl font-bold text-3xl hover:from-purple-700 hover:to-pink-700 transition-all duration-300 shadow-2xl hover:shadow-purple-500/25 transform hover:-translate-y-2">
